...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i finger.raw -o finger.jp2 -F 500,500,1,8,u"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i 003_R02.raw -o 003_R02.jp2 -F 908,1007,1,8,u"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i 007_R02.raw -o 007_R02.jp2 -F 945,1107,1,8,u"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
