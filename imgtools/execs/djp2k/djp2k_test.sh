...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i finger.jp2 -o finger.pnm"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i finger.jp2 -o finger.raw"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i 003_R02.jp2 -o 003_R02.raw"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i 007_R02.jp2 -o 007_R02.raw -x 007_R02.Idx"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
