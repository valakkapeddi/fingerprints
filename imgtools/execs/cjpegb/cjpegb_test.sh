...
cd $test_path
cp ../../data/face/gray/raw/face.raw face08.raw
cp ../../data/face/rgb/raw/intrlv/face.raw face24.raw
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program 50 jpb face08.raw -r 768,1024,8"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$prog_path/rdjpgcom face08.jpb"
echo $cmd "> face08.ncm"
START=$(date +%s)
$cmd > face08.ncm
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program 50 jpb face24.raw -raw 768,1024,24"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$prog_path/rdjpgcom face24.jpb"
echo $cmd "> face24.ncm"
START=$(date +%s)
$cmd > face24.ncm
END=$(date +%s)
