...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program ../../data/oas/fv[1-9].oas fv1-9.men - fv1-9.cov - n 100"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s) 
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program ../../data/oas/fv1.oas fv1.men - fv1.cov - n 100"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s) 
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program ../../data/oas/fv2.oas fv2.men - fv2.cov - n 100"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s) 
