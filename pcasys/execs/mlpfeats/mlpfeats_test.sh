...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program ../lintran/fv1-9mlp_nist.kls ../../data/oas/fv1-9.cls fv1-9mlp.kls"
echo $cmd "> fv1-9mlp.err"
START=$(date +%s)
$cmd > fv1-9mlp.err
END=$(date +%s) 
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program ../lintran/sv10mlp_nist.kls ../../data/oas/sv10.cls sv10mlp.kls"
echo $cmd "> sv10mlp.err"
START=$(date +%s)
$cmd > sv10mlp.err
END=$(date +%s) 
. $bench_path/exec_time.sh
