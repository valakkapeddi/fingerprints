...
echo ----------------------------------------
echo ----------------------------------------
#cmd="$program $NBIS_TEST_DIR/nfiq/execs/znormdat/znorm_nist.dat ../fing2pat/nonorm_nist.bin Znorm.bin";
cmd="$program $prog_path/../nfiq/runtimedata/znorm.dat ../fing2pat/nonorm_nist.bin norm.bin";
