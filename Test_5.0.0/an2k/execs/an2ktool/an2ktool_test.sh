...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -d 2.12.1.4 ../../data/nist.an2 delete.an2"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -i 2.12.1.4 A delete_nist.an2 insert.an2"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -s 2.12.1.4 A ../../data/nist.an2 subitem.an2"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -s 2.12.1 subfld.fmt ../../data/nist.an2 subfld.an2"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
