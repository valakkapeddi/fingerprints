...
cd $test_path
cp ../../data/face/rgb/raw/intrlv/face.raw .
echo "cp ../../data/face/rgb/raw/intrlv/face.raw ."
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program ycc face.raw -r 768,1024,24 -Y 4,4:1,1:1,1"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$prog_path/cjpegl jpl face.ycc -raw 768,1024,24 -Y 4,4:1,1:1,1"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$prog_path/rdjpgcom face.jpl"
echo $cmd
START=$(date +%s)
$cmd > facejpl.ncm
END=$(date +%s)
