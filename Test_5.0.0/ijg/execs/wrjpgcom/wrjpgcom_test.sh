...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -cfile comment.txt ../../../imgtools/data/finger/gray/jpegl/finger.jpl"
echo $cmd "> finger.jpl"
START=$(date +%s)
$cmd > finger.jpl
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program -cfile comment.txt ../../../imgtools/data/face/rgb/jpegb/face.jpb"
echo $cmd "> face.jpb"
START=$(date +%s)
$cmd > face.jpb
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
cmd="$prog_path/rdjpgcom face.jpb"
echo $cmd "> face.com"
START=$(date +%s)
$cmd > face.com
END=$(date +%s)
