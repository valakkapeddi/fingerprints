...
echo ----------------------------------------
echo ----------------------------------------
cmd="$program imgcls.lst nonorm.bin"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
...
echo ----------------------------------------
echo ----------------------------------------
#cmd="$program -z $NBIS_TEST_DIR/nfiq/execs/znormdat/znorm_nist.dat imgcls.lst norm.bin"
cmd="$program -z $prog_path/../nfiq/runtimedata/znorm.dat imgcls.lst norm.bin"
echo $cmd
START=$(date +%s)
$cmd
END=$(date +%s)
